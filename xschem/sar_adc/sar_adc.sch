...
S {}
E {}
C {bsswitch.sym} 10 -50 0 0 {name=x1}
C {dac.sym} 10 70 0 0 {name=x2}
C {preamp_comparator.sym} 80 200 0 0 {name=x3}
C {xor_clk_gen.sym} 10 320 0 0 {name=x4}
C {controller.sym} 10 480 0 0 {name=x5}
...
C {devices/lab_pin.sym} 0 160 0 1 {name=p9 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 0 240 0 1 {name=p10 sig_type=std_logic lab=GND}
...
C {devices/lab_pin.sym} -70 180 0 0 {name=p16 sig_type=std_logic lab=vsample_p}
C {devices/lab_pin.sym} -70 220 0 0 {name=p17 sig_type=std_logic lab=vsample_n}
...
C {devices/lab_pin.sym} 80 190 0 1 {name=p22 sig_type=std_logic lab=comp_p}
C {devices/lab_pin.sym} 80 210 0 1 {name=p23 sig_type=std_logic lab=comp_n}
...
C {devices/lab_pin.sym} -70 200 0 0 {name=p39 sig_type=std_logic lab=comp_clk}
